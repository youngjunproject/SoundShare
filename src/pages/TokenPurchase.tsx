    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Download Tokens</h1>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">{currentTokens} tokens remaining</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {TOKEN_PACKAGES.map(({ tokens, price }) => (
              <div key={tokens} className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900">{tokens} Tokens</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Token History</h2>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">
                          {entry.operation_type === 'consume' ? 'Used' : 'Purchased'}{' '}
                          {Math.abs(entry.tokens_changed)} token{Math.abs(entry.tokens_changed) !== 1 ? 's' : ''}
                        </p>
